...
public class PagerTab extends ViewGroup {
	...
	private int mIndicatorColor = 0xFF11CD6E;//指示器颜色
	...
	public int mTabTextSize = 12; //tab文字大小
...
//		ViewPropertyAnimator.animate(tab).scaleX(tab.isSelected()?1.2f:1.0f).setDuration(200);
//		tab.setTextSize(tab.isSelected()?20:12);
